...
from adparser.sites.cityxguide_com import cityxguide_com
from utils.ads.adstore import get_ad_page

AD_PARSERS = {"cityxguide.com": None}  # cityxguide_com}
...
def parse_ads(domain, page):
    ...
    if parser is None:
        ...
        return {}, []
    ad_data, image_urls = parser(page)
    return ad_data, image_urls
